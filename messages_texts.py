...
Якщо хочеться поговорити раніше, можна написати мені напряму: @kryskaks
'''
...
Якщо захочеш приєднатися до наступного запуску — напиши мені, і я додам тебе до списку: @kryskaks
'''
